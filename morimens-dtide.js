...
const dtideHeatStyle=(rate,max=35)=>{const t=Math.max(0,Math.min(1,Number(rate||0)/max)),h=Math.round(215-215*t),a=(.08+.34*t).toFixed(2);return `--dtide-heat:hsla(${h},78%,46%,${a})`};
